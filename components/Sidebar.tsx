  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        {!collapsed && (
          <div>
            <div style={{ fontWeight: 700, fontSize: "15px", color: "var(--primary)", letterSpacing: "-0.3px" }}>
              FOCCA
            </div>
        ...
        <button
          ...
          style={{ background: "none", border: "none", cursor: "pointer", color: "var(--muted)", fontSize: "16px", padding: "4px", flexShrink: 0 }}
        >
          {collapsed ? ">" : "<"}
        </button>
      </div>
